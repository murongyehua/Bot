...
public interface GameConsts {
    ...
    interface CommonTip {
        ...
        String LOGIN_TIP = "欢迎回来,[%s],回复数字【1】进入游戏,当前公告："+ StrUtil.CRLF + "1.新用户注册登录即送3张唤灵符" + StrUtil.CRLF + "2.幻灵可以携带or放置了!!所有幻灵默认放置，需要携带的请自行到[我的幻灵]菜单进行操作~" + StrUtil.CRLF + "3.修复了部分已知问题";
