...
public interface GameConsts {
    ...
    interface CommonTip {
        ...
        String LOGIN_TIP = "欢迎回来,[%s],回复数字【1】进入游戏,当前公告："+ StrUtil.CRLF + "新用户注册登录即送3张唤灵符" + StrUtil.CRLF + "友情提示：" + StrUtil.CRLF + "根据机器人重制计划，近期将对游戏进行删档操作，望知悉。" + StrUtil.CRLF +"1.2.10.0版本更新内容\n" +
                "【基础变更】\n" +
