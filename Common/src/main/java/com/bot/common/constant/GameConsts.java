...
public interface GameConsts {
    ...
    interface CommonTip {
        ...
        String LOGIN_TIP = "欢迎回来,[%s],回复数字【1】进入游戏,当前公告："+ StrUtil.CRLF + "新用户注册登录即送3张唤灵符" + StrUtil.CRLF + "2.8.0版本更新内容\n" +
                "【基础变更】\n" +
                "1. 增加了新幻灵\n" +
                "易安[珍稀](火)\n" +
                "玄古遗情[珍稀](金)\n" +
                "2. 增加了技能卡，这些技能卡将只在蓬莱山掉落\n" +
                "白虹贯日(金)\n" +
                "摘叶飞花(木)\n" +
                "洗净铅华(水)\n" +
                "迅疾如雷(火)\n" +
                "坚不可摧(土)\n" +
                "3. 提升了绝世幻灵与珍稀幻灵被抽取的概率，绝世与珍稀的综合概率大约提升了5-10倍，相应的，普通和精英被抽取的概率降低了5-10倍，强势拯救非酋(只在此版本提升，下次更新将会回调)\n" +
                "4. 增加了近十个称号，在游戏过程中细细探索，说不定什么时候就能获取到新的称号\n" +
                "5. 调整世界Boos机制，每个时间段都将会刷新新的Boos，以此保证产出充足的灵石与道具，游戏更轻松\n" +
                "【新增内容】\n" +
                "1.  重做了好友系统，新增了删除好友和寄信功能，可以给好友寄信寄物品了，礼尚往来，岂不快哉\n" +
                "2. 新增驿站菜单，此处将会存放尚未读取的好友消息与系统消息，已读过的消息将不会显示\n" +
                "3. 新增剧情，每个大版本都将拥有不一样的背景故事，山海世界与你共同成长，所爱隔山海，山海皆可平\n" +
                "【优化内容】\n" +
                "1. 优化了探索菜单的显示，让菜单名称看起来不那么直白，玩起来更有代入感\n" +
                "2. 修复了部分已知问题\n" +
                "【更新补偿】\n" +
                "此次更新后，所有玩家将会获得唤灵符*1\n" +
                "更新补偿将通过邮件发放\n";
