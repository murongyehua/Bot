...
public enum ENGameInfo {
    ...
    LOVE_LETTER(3,"情书", "LOVE_LETTER", 2, 4, "LoveLetterGamePlay", "【情书】游戏规则\n" +
            "⚠️ 注意：本游戏仅支持私聊参与！\n" +
            "─────────────\n" +
            "【牌堆组成】\n" +
            "1-守卫(5张)：猜测对手手牌（不能猜守卫），猜中则对方出局\n" +
            "2-祭司(2张)：查看一个对手的手牌\n" +
            "3-男爵(2张)：比较手牌数字，小者出局（平局无事）\n" +
            "4-侍女(2张)：到下回合前对手效果无法选中自己\n" +
            "5-王子(2张)：令对手弃牌重抽（牌堆空则出局）\n" +
            "6-国王(1张)：和对手交换手牌\n" +
            "7-女伯爵(1张)：持有国王或王子时必须弃掉\n" +
            "8-公主(1张)：打出或弃掉则出局\n" +
            "─────────────\n" +
            "【游戏流程】\n" +
            "1. 准备：洗牌后移除若干张（2人移除3张，其他移除1张），每人发1张起始手牌\n" +
            "2. 回合操作：\n" +
            "   • 摸1张牌（手牌变为2张）\n" +
            "   • 选择【打 序号】打出一张牌并触发效果\n" +
            "   • 或选择【丢弃 序号】不触发效果直接丢弃\n" +
            "3. 出局规则：被守卫猜中、男爵比输、弃掉公主、被王子指定但牌堆空\n" +
            "─────────────\n" +
            "【结束条件】\n" +
            "• 单局：仅剩1人存活或牌堆空（比较手牌数字，大者胜）\n" +
            "• 整场：胜者获得1个钟情标记💕，先集齐5个获得最终胜利\n" +
            "─────────────\n" +
            "【积分奖励】\n" +
            "• 最终获胜者：6积分\n" +
            "• 其他参与者：1积分\n" +
            "─────────────\n" +
            "游戏过程中可随时使用【钟情标记】或【标记】查看当前情况");
