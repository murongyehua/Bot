...
public interface GameConsts {
    ...
    interface CommonTip {
        ...
        String LOGIN_TIP = "欢迎回来,[%s],回复数字【1】进入游戏,当前公告："+ StrUtil.CRLF + "1.新用户注册登录即送3张唤灵符" + StrUtil.CRLF + "2.全新版本发布，更多玩法上线" + StrUtil.CRLF + "【基础变更】\n" +
                "1. 等级上限开放至25级\n" +
                "2. 世界boos等级调至35级，世界boos属性也进行相应的提升，世界boos奖励调整为:\n" +
                ...
                "5. 调整了部分道具的掉落几率\n" +
                "【新增内容】\n" +
                "1. 新增法宝系统，每人同时只能佩戴一个法宝，法宝会给参战幻灵进行加成，获得同样的法宝会提升法宝的灵气，法宝灵气最多5级，法宝通过副本获取，法宝页面从[个人信息]菜单进入\n" +
                "2. 新增组队副本，掉落特有的技能卡、法宝，副本入口为[外出探索]→[时光溯流]菜单，目前仅有一个副本，建议幻灵25级后再尝试探索\n" +
                "3. 原有探索地图新增21级怪物\n" +
                "4. 增加新的探索地图[蓬莱山]，驻扎的怪物为20级-30级，只有至少拥有一只20级及其以上幻灵的玩家才可进入，蓬莱山有一定的几率掉落天命散，更利于幻灵升级\n" +
                "5. 增加全服战灵力最高者专属称号[山海乾坤]，每日更新\n" +
                "6. 增加神秘商店，使用灵石可以在神秘商店消费，灵石可以通过各类探索获取\n" +
                "7. 增加物品出售功能，不用的道具可以出售，换取灵石，个人当前的灵石数量可在[个人信息]菜单查看\n" +
                "8. 增加一键返回主菜单功能，随着菜单层级越来越多，返回主菜单变得越来越不方便，因此增加了直接回到主菜单的功能，但部分菜单不可用\n" +
                "9. 增加道具[溢灵散]，给幻灵使用后可以使其遗忘一个已学会的技能，腾出技能槽，以后学技能再也不用瞻前顾后了，溢灵散可通过挑战副本获得，也可以在神秘商店购买\n" +
                "【优化内容】\n" +
                "1. 优化战斗详情描述，更便于分析、理解战斗机制\n" +
                "【更新奖励】\n" +
                "更新后，全服玩家将获得灵石*100\n";
