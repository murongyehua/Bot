...
public enum ENWeaponEffect {
    //
    W01("W01", "翻天印", "参战幻灵的攻击提升%s%", new Integer[]{5,6,7,8,10}),
    W02("W02", "护灵甲", "参战幻灵的防御提升%s%", new Integer[]{5,6,7,8,10}),
    W03("W03", "玄王佩", "参战幻灵的血量提升%s%", new Integer[]{5,6,7,8,10}),
    W04("W04", "醒世符", "每次战斗参战幻灵可免疫伤害%s回合", new Integer[]{1,1,1,1,2}),
    W05("W05", "解灵囊", "每次战斗参战幻灵可免疫负面效果%s回合", new Integer[]{1,1,1,1,2}),
    W06("W06", "禁灵镜", "每次战斗禁止目标使用技能，持续%s回合", new Integer[]{1,1,2,1,3}),
    W07("W07", "极影斗篷", "参战幻灵的速度提升%s%", new Integer[]{5,7,9,11,13});
